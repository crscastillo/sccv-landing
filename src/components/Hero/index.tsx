            ...
            <div className="w-full px-4">
              ...
              >
                <h1 className="mb-6 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                  Simplificamos su proceso contable y tributario asi como brindamos servicios de asistencia para PYMES
                </h1>
                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                  Con mas de 40 anos de experiencia en el proceso contable y asesoria PYMES, Servicios Contables Castillo Vargas es una
                  mezcla de conocimiento  e innovacion para ayudar a su empresa a....
                </p>
